...
Public Class WebService1
    ...
    Public Function MainProcess(ByVal inv_tran As String) As String
        ...
        Try
            ...
            cmd.Connection = Conn
            cmd.CommandText = "Select rownum ,IMFR_UD_MURATA_TYPE from (Select distinct IMFR_UD_MURATA_TYPE,Imfr_Ud_Pkg_Id, Imfr_Ud_Inv_Seq from imfr_ut_mtlgls0004 
            ...
            cmd.Connection = Conn
            cmd.CommandText = "SELECT IMFR_UD_MURATA_TYPE,Imfr_Ud_Pkg_Id, Imfr_Ud_Inv_Seq,IMFR_UD_TARIFF,SUM(IMFR_UD_QTY) ,IMFR_UD_PRICE,SUM(IMFR_UD_QTY*IMFR_UD_PRICE) 
                               FROM IMFR_UT_MTLGLS0004 WHERE IMFR_UD_INV_NO = '" & inv_tran & "' AND IMFR_UD_PKG_ID != 'CART'  
                               Group by IMFR_UD_MURATA_TYPE,IMFR_UD_PRICE,IMFR_UD_TARIFF ,Imfr_Ud_Pkg_Id, Imfr_Ud_Inv_Seq 
            ...
            cmd.Connection = Conn
            cmd.CommandText = "SELECT SUM(IMFR_UD_QTY),SUM(IMFR_UD_PRICE), SUM(IMFR_UD_QTY*IMFR_UD_PRICE) FROM IMFR_UT_MTLGLS0004 WHERE IMFR_UD_INV_NO = '" & inv_tran & "'  AND IMFR_UD_PKG_ID = 'CART' AND substr(Imfr_Ud_Murata_Type,1,1) = 'P'"
            ...
            cmd.Connection = Conn
            cmd.CommandText = "SELECT SUM(IMFR_UD_QTY),SUM(IMFR_UD_PRICE), SUM(IMFR_UD_QTY*IMFR_UD_PRICE) FROM IMFR_UT_MTLGLS0004 WHERE IMFR_UD_INV_NO = '" & inv_tran & "'  AND IMFR_UD_PKG_ID = 'CART' AND (substr(Imfr_Ud_Murata_Type,1,1) = 'W' or substr(Imfr_Ud_Murata_Type,1,1) = 'C') "
            ...
            If Left(inv_tran, 2) = "TF" Then
                cmd.CommandText = "Select CD12064,DH35137_01,DH35137_02,DH10637_01,DH10637_02,
                                DH10637_03,DH10637_04 from SV6030 WHERE CD12064 ='MTL'"
            Else
                cmd.CommandText = "Select CD12064,DH35137_01,DH35137_02,DH10637_01,DH10637_02," +
                       "DH10637_03,DH10637_04 from SV6030 WHERE CD12064 ='HUB'"
            End If
            ...
            If Left(inv_tran, 2) = "TF" Then
                cmd.CommandText = "Select CD12064,DH35137_01,DH35137_02,DH10637_01,DH10637_02,DH10637_03,DH10637_04 from SV6030 WHERE  CD12064 ='HUB' "
            Else
                cmd.CommandText = "Select CD12064,DH35137_01,DH35137_02,DH10637_01,DH10637_02,DH10637_03,DH10637_04 from SV6030 WHERE  CD12064 ='MTL' "
            End If
            cmd.CommandType = CommandType.Text
            ...
            If Left(inv_tran, 2) = "TF" Then
                cmd.CommandText = "select 'FOB. ' || KB10990 as KB10990 from SV6129 WHERE NO10667= 'FOB' AND DH10946= 'SBM'"
            Else
                cmd.CommandText = "select KB10990 from SV6129 WHERE NO10667= 'FOL' AND DH10946= 'SBM'"
            End If
            cmd.CommandType = CommandType.Text
            ...
            Dim image_logo As XImage = XImage.FromFile("\\163.50.57.110\wwwroot$\GLS004\image\logo.png")

            Dim image_stramp As XImage = XImage.FromFile("\\163.50.57.110\wwwroot$\GLS004\image\stamp.png")
            ...
            New XRect(40, y, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomLeft)
                ...
                '//////////////////////////////////////////////////////////////////////////////////////////
                graph.DrawString(CDbl(tbl_tye_not_c.Rows(i)("SUM(IMFR_UD_QTY)")).ToString("N0"), font, XBrushes.Black,
                ...
                graph.DrawString((CDbl(tbl_tye_not_c.Rows(i)("SUM(IMFR_UD_QTY*IMFR_UD_PRICE)"))).ToString("N2"), font, XBrushes.Black,
                New XRect(-30, y, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomRight)


                sum_qty = sum_qty + CDbl(tbl_tye_not_c.Rows(i)("SUM(IMFR_UD_QTY)").ToString)
                sum_amount = sum_amount + CDbl(tbl_tye_not_c.Rows(i)("SUM(IMFR_UD_QTY*IMFR_UD_PRICE)").ToString)
                ...
                If i = tbl_sum.Rows.Count - 1 Then
                    ...
                    'Case cart and pallet
                    If (Not IsDBNull(tbl_type_head_p.Rows(0)("Sum(Imfr_Ud_Qty)")) And Not IsDBNull(tbl_type_head_c.Rows(0)("Sum(Imfr_Ud_Qty)"))) Then
                       ...
                       New XRect(20, y + 125, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomLeft)
                        ...
                        'Case pallet
                    ElseIf (Not IsDBNull(tbl_type_head_p.Rows(0)("Sum(Imfr_Ud_Qty)")) And IsDBNull(tbl_type_head_c.Rows(0)("Sum(Imfr_Ud_Qty)"))) Then
                        graph.DrawString(Right("000" & tbl_sum.Rows.Count + 1.ToString, 3), font, XBrushes.Black,
                        New XRect(40, y + 23, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomLeft)
                        ...
                        graph.DrawString((CDbl(tbl_type_head_p.Rows(0)("Sum(Imfr_Ud_Qty)")) + sum_qty).ToString("N0"), font, XBrushes.Black,
                        New XRect(-250, y + 105, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomRight)

                        graph.DrawString((sum_amount_p + sum_amount).ToString("N2"), font, XBrushes.Black,
                        New XRect(-30, y + 105, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomRight)

                        graph.DrawString("( BATH :" + NumeriCon.ConvertNum(sum_amount_p + sum_amount) + ")", font, XBrushes.Black,
                       New XRect(20, y + 125, pdfPage.Width.Point, pdfPage.Height.Point), XStringFormats.BottomLeft)
